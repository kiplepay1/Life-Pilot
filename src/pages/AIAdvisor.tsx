...
import type { AIMessage, Income, Expense, Bill, Subscription, SavingsGoal, Task } from '@/types'
    ...
    <div className="flex h-[calc(100vh-8rem)] flex-col">
      <div className="mb-4">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-2xl font-bold tracking-tight text-slate-900">AI Advisor</h1>
        </div>
          ...
          {messages.length === 0 && (
            <div className="flex h-full flex-col items-center justify-center gap-4 text-center">
              ...
              <p className="max-w-sm text-sm text-slate-500">
                Ask me anything about your money, bills, subscriptions or savings — I only ever look at your own
